...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(flash..":NameBot:")
...
var =  'البابا جاك'
elseif  UserID == 11111111146889000 then
var =  'مطور السورس'
elseif redis:sismember(flash..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(flash..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(flash..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(flash..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(flash..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(flash..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(flash..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(flash..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(flash..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(flash..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(flash..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(flash..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(flash..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(flash..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(flash..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(flash..':SUDO_BOT:')
message = '⋆ ** قائمه الـمـطـوريـن : \n\n`⋆ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(flash..'username:'..v)
local count = redis:scard(flash..'mtwr_count'..v)
...
local monsha = redis:smembers(flash..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⋆ قائمه المدراء :*\n\n'
local list = redis:smembers(flash..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(flash..'admins:'..msg.chat_id_)
...
local list = redis:smembers(flash..'whitelist:'..msg.chat_id_)
...
if redis:sismember(flash..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(flash..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(flash..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(flash..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(flash..'gban_users')
...
local list = redis:smembers(flash..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(flash..':Filter_Word:'..msg.chat_id_,word) then 
return  "⋆ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(flash..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(flash..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(flash..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(flash..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(flash..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(flash..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(flash..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(flash..'group:ids')
message = '⋆ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(flash..'group:name'..v)
if info then 
...
redis:del(
flash..'group:add'..id_group,
flash..'lock_link'..id_group, 
flash..'lock_id'..id_group,
flash..'lock_spam'..id_group, 
flash..'lock_webpage'..id_group,
flash..'lock_markdown'..id_group,
flash..'lock_flood'..id_group,
flash..'lock_bots'..id_group,
flash..'mute_forward'..id_group,
flash..'mute_contact'..id_group,
flash..'mute_location'..id_group,
flash..'mute_document'..id_group,
flash..'mute_keyboard'..id_group,
flash..'mute_game'..id_group,
flash..'mute_inline'..id_group,
flash..'lock_username'..id_group,
flash..'num_msg_flash'..id_group,
flash..'replay'..id_group
)
redis:srem(flash..'group:ids',id_group)
end
...
redis:hset(flash..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(flash..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(flash..'group:add'..msg.chat_id_) then  return '⋆ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(flash..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(flash..':addnumberusers') or 0)
...
local lock_service = redis:get(flash..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆*تم تفعيل المجموعه . \n*⋆ ورفع كل المشرفين\n [SOURCE FLASH](t.me/SUORSFLASH)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(flash..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(flash..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
flash..'group:add'..msg.chat_id_,true,
flash..'lock_link'..msg.chat_id_,true, 
flash..'lock_id'..msg.chat_id_,true,
flash..'lock_spam'..msg.chat_id_,true,
flash..'lock_webpage'..msg.chat_id_,true,
flash..'lock_markdown'..msg.chat_id_,true,
flash..'lock_flood'..msg.chat_id_,true,
flash..'lock_bots'..msg.chat_id_,true,
flash..'mute_forward'..msg.chat_id_,true,
flash..'mute_contact'..msg.chat_id_,true,
flash..'mute_location'..msg.chat_id_,true,
flash..'mute_document'..msg.chat_id_,true,
flash..'mute_keyboard'..msg.chat_id_,true,
flash..'mute_game'..msg.chat_id_,true,
flash..'mute_inline'..msg.chat_id_,true,
flash..'lock_username'..msg.chat_id_,true,
flash..'num_msg_flash'..msg.chat_id_,5, 
flash..'replay'..msg.chat_id_,true
)

redis:sadd(flash..'group:ids',msg.chat_id_) 
redis:sadd(flash..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(flash..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(flash..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(flash..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(flash..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID,'username',Resolv)
redis:sadd(flash..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(flash..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(flash..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(flash..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID,'username',Resolv)
redis:sadd(flash..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(flash..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(flash..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(flash..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(flash..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(flash..'whitelist:'..ChatID,UserID)
...
if redis:sismember(flash..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..'owners:'..ChatID,UserID)
...
if redis:sismember(flash..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(flash..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(flash..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(flash..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(flash..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(flash..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(flash..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(flash..'banned:'..ChatID,UserID)
...
if redis:sismember(flash..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(flash..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(flash..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(flash..'username:'..UserID, 'username',Resolv)
redis:sadd(flash..'gban_users',UserID)
...
redis:srem(flash..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(flash..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(flash..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(flash..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(flash..'username:'..UserID, 'username', UserName)
redis:sadd(flash..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(flash..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⋆ **العضو » ❪ '..UserName..' ❫\n⋆ **الايدي » ❪ `'..UserID..'` ❫\n⋆ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(flash..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(flash..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(flash..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(flash..'username:'..UserID, 'username', Resolv)
redis:sadd(flash..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(flash..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(flash..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ **العضو » '..USERNAME..' \n⋆ ** الايدي » (`'..UserID..'`)\n⋆ **انه بالتأكيد ليس مطور \n') end
redis:srem(flash..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(flash..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(flash..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(flash..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(flash..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⋆*` اعدادات المجموعه :` \n"
.."\n⋆ التعديل «» "..(redis:get(flash..'lock_edit'..msg.chat_id_) or 'false')
.."\n⋆ الروابط «» "..(redis:get(flash..'lock_link'..msg.chat_id_) or 'false')
.."\n⋆ التاك «» "..(redis:get(flash..'lock_tag'..msg.chat_id_) or 'false')
.."\n⋆ المعرفات «» "..(redis:get(flash..'lock_username'..msg.chat_id_) or 'false')
.."\n⋆ التكرار «» "..(redis:get(flash..'lock_flood'..msg.chat_id_) or 'false')
.."\n⋆ الكلايش «» "..(redis:get(flash..'lock_spam'..msg.chat_id_) or 'false')
.."\n⋆ الويب «» "..(redis:get(flash..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⋆ الماركدوان «» "..(redis:get(flash..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⋆ بالطرد البوتات «» "..(redis:get(flash..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⋆ البوتات «» "..(redis:get(flash..'lock_bots'..msg.chat_id_) or 'false')
.."\n⋆ عدد التكرار «» "..(redis:get(flash..'num_msg_flash'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⋆`اعدادات الوسائط :`\n"
.."\n*⋆ *المتحركه «» "..(redis:get(flash..'mute_gif'..msg.chat_id_) or 'false')
.."\n⋆ الدردشه «» "..(redis:get(flash..'mute_text'..msg.chat_id_) or 'false')
.."\n⋆ الانلاين «» "..(redis:get(flash..'mute_inline'..msg.chat_id_) or 'false')
.."\n⋆ الالعاب «» "..(redis:get(flash..'mute_game'..msg.chat_id_) or 'false')
.."\n⋆ الصور «» "..(redis:get(flash..'mute_photo'..msg.chat_id_) or 'false')
.."\n⋆ الفيديو «» "..(redis:get(flash..'mute_video'..msg.chat_id_) or 'false')
.."\n⋆ البصمات «» "..(redis:get(flash..'mute_audio'..msg.chat_id_) or 'false')
.."\n⋆ الصوت «» "..(redis:get(flash..'mute_voice'..msg.chat_id_) or 'false')
.."\n⋆ الملصقات «» "..(redis:get(flash..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⋆ الجهات «» "..(redis:get(flash..'mute_contact'..msg.chat_id_) or 'false')
.."\n⋆ التوجيه «» "..(redis:get(flash..'mute_forward'..msg.chat_id_) or 'false')
.."\n⋆ الموقع «» "..(redis:get(flash..'mute_location'..msg.chat_id_) or 'false')
.."\n⋆ الملفات «» "..(redis:get(flash..'mute_document'..msg.chat_id_) or 'false')
.."\n⋆ الاشعارات «» "..(redis:get(flash..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⋆ الكيبورد «» "..(redis:get(flash..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*`اعدادات اخرى : `"
.."\n\n*⋆*الترحيب «» "..welcomex
.."\n*⋆*الردود «» "..replayx
...
.."\n*⋆*الويب «» "..(redis:get(flash..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⋆*الماركدوان «» "..(redis:get(flash..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات بالطرد «» "..(redis:get(flash..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات «» "..(redis:get(flash..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⋆*عدد التكرار «» "..(redis:get(flash..'num_msg_flash'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*اعدادات التقـييد :\n"
.."\n*⋆*التقييد بالتوجيه «» "..(redis:get(flash..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالصور «» "..(redis:get(flash..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالروابط «» "..(redis:get(flash..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالمتحركه «» "..(redis:get(flash..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد الفيديو «» "..(redis:get(flash..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
